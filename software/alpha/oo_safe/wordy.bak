...
char *substitution::substfor(char *s, bool &any)
...
void substitution::match(char *s1, int &p1, char *s2, int &p2, bool &any)
  { /* search list of sets, find longest which matches s1[p1..], stuff it into s2[p2..] */
    until (s1[p1] == '\0')
