...
#define ICONFN	 "/usr/fisher/lib/alpha/icon"
#define MENUFN	 "/usr/fisher/lib/alpha/menu"
...
static makeframe(px, py, sx, sy) int px, py, sx, sy;
  { struct rect rect;
    ...
    setenv("WORDY_CONFIG", "/usr/fisher/print/sun.cfg");
...
static subwin(px, py, sx, sy, astr, p1, p2, p3) int px, py, sx, sy; char *astr; word p1, p2, p3;
  { char buf[MAXSTRLEN+1];
    ...
    spawn("/usr/fisher/bin/wshell", buf, px, py, px+sx, py+sy, p1, p2, p3);
  }
